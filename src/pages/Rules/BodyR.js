...
export const BodyR = () => {
    ...
    return (
        <div className='duel__bodyR  section__padding' id="home">
            <div className='duel__bodyR-content'>
                <div className='duel__bodyR-content_container'>
                    <div className='duel__bodyR-content_container'>
                        <h1 id="text1">Game Actions</h1><br></br>
                            A. Attacking<br></br>
                            B. Tribute Summoning PP 9 & 10 Creature<br></br>
                            C. Summoning Effect Card<br></br>
                            D. Summoning Counter Card (casted during opponent's turn)<br></br>
                            E. Summoning Wild Card<br></br>
                            F. Passing turn<br></br>
                            G. Bluff (face-down summon)<br></br>
                            H. Drawing from deck<br></br>
                    </div>
                    <div className='duel__bodyR-content_container'>
                        <h1  id="text2">Game Details</h1><br></br>
                            A. 15 card decks per game per player, 5 cards drawn per hand to start<br></br>
                            ...
                            H. Players can bluff summon 2 times per game<br></br>
                    </div>
                    <div className='duel__bodyR-content_container'>
                        <h1 id="text3">First Main Phase</h1><br></br>
                            A. Draw 1 card from deck<br></br>
                            B. Player’s may summon 1 Creature per turn. A Creature cannot attack until it has been on the field for at least
                            1 turn<br></br>
                            C. Once you are done summoning, the next player’s turn begins and repeats this step<br></br>
                            <br></br>

                    </div>
                    <div className='duel__bodyR-content_container'>
                        <h1 id="text4">Combat Step</h1><br></br>
                        <h2 id="text3">Declare attackers step</h2><br></br>
                            A. Players decide which of the opponent’s Creature(s) their casted Creature will attack<br></br>
                            ...
                            1 full turn<br></br><br></br>
                        <h2 id="text3">Combat Step</h2><br></br>
                            ...
                            graveyard<br></br>
                            E. Applicable counter cards may be used during the opposing player’s attack turn<br></br>
                    </div>
                    <div className='duel__bodyR-content_container'>
                        <h1 id="text5">Graveyard</h1><br></br>
                            A. Creatures killed during the attack phase are automatically moved to the discard pile and cannot be reused
                            unless a resurrection effect card is activated<br></br>
                            B. Revived Creatures return to the field, not the player’s hand<br></br>
                            C. A revived Creature may not attack on the same turn it is revived<br></br>
                    </div>
                    <div className='duel__bodyR-content_container'>
                    ...
                    <div className='duel__bodyR-content_container'>
                        <h1 id="text7">Duel Realms Cards</h1><br></br>
                            ...
                            ● &ensp;Gambler’s Trade: Burn 1 card from your hand to draw another from the top of your deck<br></br>
                    ...
                    <div className='duel__bodyR-content_container'>
                        ...
                        ● &ensp;Fatal Curse: Decrease an opposing Creature on the field's PP by 5 prior to damage calculation.<br></br>
                    ...
                    <div className='duel__bodyR-content_container'>
                        ...
                        ● &ensp;Sacrificial Lamb: Discard 1 card from your hand to take no damage to your life points for that turn.<br></br>
                    ...
                    <div className='duel__bodyR-content_container'>
                        ...
                        survived at least one turn.<br></br>
                        ...
                        ➢ 3 Cards with second highest pp possible (9pp), no downside<br></br><br></br>
                                    ...
                                    &emsp;&emsp;■ These creatures can attack the turn they are summoned.<br></br><br></br>
                                        ...
                                        graveyard and the attack is negated. The face down Creature is now face up<br></br>

                    </div>
                    <div className='duel__bodyR-content_container'>
                        <h1 id="text8">Situational Rules</h1><br></br>
                            A. Players draw 5 cards prior to the first main phase. Then, 1 card is drawn at the beginning of each turn.<br></br>
